...
class Turtlebot2Nav2MultiBTsSM(Behavior):
	...
	def __init__(self, node):
		super(Turtlebot2Nav2MultiBTsSM, self).__init__()
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('Loader',
										BtLoaderState(bt_topic="bt_loader", filepaths=["flex_bt_turtlebot2_demo_bringup/behavior_trees/nav2_plan_path.xml", "flex_bt_turtlebot2_demo_bringup/behavior_trees/nav2_follow_path.xml", "flex_bt_turtlebot2_demo_bringup/behavior_trees/nav2_recovery_fallback.xml"], timeout=5.0),
			...
			OperatableStateMachine.add('PlanPath',
										BtExecuteGoalState(bt_topic="bt_executor", bt_file="flex_bt_turtlebot2_demo_bringup/behavior_trees/nav2_plan_path.xml", goal_id="goal", goal_msg_type="PoseStamped", request_id="", request_msg_pkg="", request_msg_type=""),
			...
			OperatableStateMachine.add('FollowPath',
										BtExecuteState(bt_topic="bt_executor", bt_file="flex_bt_turtlebot2_demo_bringup/behavior_trees/nav2_follow_path.xml"),
