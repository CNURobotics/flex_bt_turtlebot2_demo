BtLoaderState#!/usr/bin/env python
# -*- coding: utf-8 -*-
###########################################################
...
from flex_bt_turtlebot2_demo_flexbe_states.charging_state import ChargingState
from flex_bt_turtlebot2_demo_flexbe_states.check_battery_life_state import CheckBatteryLifeState
from flex_bt_turtlebot2_demo_flexbe_states.get_waypoints_state import GetWaypointsState
from flex_bt_turtlebot2_demo_flexbe_states.send_waypoints_state import SendWaypointsState
...
class Turtlebot2PatrolAndInvestigateSM(Behavior):
	...
	def __init__(self, node):
		super(Turtlebot2PatrolAndInvestigateSM, self).__init__()
	...
	def create(self):
		...
		with _sm_setupbehavior_0:
			...
			OperatableStateMachine.add('LoadBTs',
										BtLoaderState(bt_topic="bt_loader", filepaths=["flex_bt_turtlebot2_demo_bringup/behavior_trees/nav2_plan_path.xml", "flex_bt_turtlebot2_demo_bringup/behavior_trees/nav2_navigate_w_detection_and_battery.xml", "flex_bt_turtlebot2_demo_bringup/behavior_trees/nav2_recovery_fallback.xml", "flex_bt_turtlebot2_demo_bringup/behavior_trees/nav2_navigate_to_pose.xml", "flex_bt_turtlebot2_demo_bringup/behavior_trees/red_ball_behavior.xml", "flex_bt_turtlebot2_demo_bringup/behavior_trees/green_ball_behavior.xml", "flex_bt_turtlebot2_demo_bringup/behavior_trees/blue_ball_behavior.xml"], timeout=5.0),
		...
		with _sm_navigate_1:
			...
			OperatableStateMachine.add('FollowPath',
										BtExecuteGoalState(bt_topic="bt_executor", bt_file="flex_bt_turtlebot2_demo_bringup/behavior_trees/nav2_navigate_w_detection_and_battery.xml", goal_id="min_battery", goal_msg_type="double", request_id="battery_percentage", request_msg_pkg="", request_msg_type="double"),
		...
		_sm_patrol_2 = OperatableStateMachine(outcomes=['failed', 'canceled', 'low_battery', 'finished'], input_keys=['waypoints', 'min_battery'], output_keys=['waypoints', 'ball_location', 'ball_label'])
		...
		with _sm_patrol_2:
			...
			OperatableStateMachine.add('Navigate',
										_sm_navigate_1,
										transitions={'finished': 'ContinuePatrolling', 'failed': 'failed', 'low_battery': 'low_battery', 'ball_detected': 'finished'},
										autonomy={'finished': Autonomy.Inherit, 'failed': Autonomy.Inherit, 'low_battery': Autonomy.Inherit, 'ball_detected': Autonomy.Inherit},
										remapping={'min_battery': 'min_battery', 'ball_location': 'ball_location', 'ball_label': 'ball_label'})
		...
		with _sm_performballaction_3:
			...
			OperatableStateMachine.add('CheckBallColor',
										CheckBallColorState(),
										transitions={'red_ball': 'RedBallAction', 'green_ball': 'GreenBallAction', 'blue_ball': 'BlueBallAction'},
										autonomy={'red_ball': Autonomy.High, 'green_ball': Autonomy.High, 'blue_ball': Autonomy.High},
										remapping={'ball_label': 'ball_label'})

			# x:669 y:240
			OperatableStateMachine.add('GreenBallAction',
										BtExecuteState(bt_topic="bt_executor", bt_file="flex_bt_turtlebot2_demo_bringup/behavior_trees/green_ball_behavior.xml"),
										transitions={'done': 'finished', 'canceled': 'canceled', 'failed': 'failed'},
										autonomy={'done': Autonomy.High, 'canceled': Autonomy.High, 'failed': Autonomy.Off})

			# x:669 y:27
			OperatableStateMachine.add('RedBallAction',
										BtExecuteState(bt_topic="bt_executor", bt_file="flex_bt_turtlebot2_demo_bringup/behavior_trees/red_ball_behavior.xml"),
										transitions={'done': 'finished', 'canceled': 'canceled', 'failed': 'failed'},
										autonomy={'done': Autonomy.High, 'canceled': Autonomy.High, 'failed': Autonomy.Off})

			# x:673 y:452
			OperatableStateMachine.add('BlueBallAction',
										BtExecuteState(bt_topic="bt_executor", bt_file="flex_bt_turtlebot2_demo_bringup/behavior_trees/blue_ball_behavior.xml"),
										transitions={'done': 'finished', 'canceled': 'canceled', 'failed': 'failed'},
										autonomy={'done': Autonomy.High, 'canceled': Autonomy.High, 'failed': Autonomy.Off})


		# x:1021 y:81, x:1014 y:246, x:609 y:286, x:1011 y:395
		_sm_investigate_4 = OperatableStateMachine(outcomes=['finished', 'failed', 'canceled', 'low_battery'], input_keys=['ball_location', 'ball_label'])

		with _sm_investigate_4:
			# x:163 y:180
			OperatableStateMachine.add('NavigateToBall',
										BtExecuteGoalState(bt_topic="bt_executor", bt_file="flex_bt_turtlebot2_demo_bringup/behavior_trees/nav2_navigate_ball_w_battery_life.xml", goal_id="goal", goal_msg_type="PoseStamped", request_id="battery_percentage", request_msg_pkg="", request_msg_type="double"),
		...
		with _sm_charge_5:
			...
			OperatableStateMachine.add('NavigateToCharger',
										BtExecuteGoalState(bt_topic="bt_executor", bt_file="flex_bt_turtlebot2_demo_bringup/behavior_trees/nav2_navigate_to_pose.xml", goal_id="goal", goal_msg_type="PoseStamped", request_id="", request_msg_pkg="", request_msg_type=""),
		...
		with _state_machine:
			...
			OperatableStateMachine.add('Investigate',
										_sm_investigate_4,
										transitions={'finished': 'Patrol', 'failed': 'Recovery', 'canceled': 'Patrol', 'low_battery': 'Charge'},
										autonomy={'finished': Autonomy.Inherit, 'failed': Autonomy.Inherit, 'canceled': Autonomy.Inherit, 'low_battery': Autonomy.Inherit},
										remapping={'ball_location': 'ball_location', 'ball_label': 'ball_label'})

			# x:594 y:200
			OperatableStateMachine.add('Patrol',
										_sm_patrol_2,
										transitions={'failed': 'Recovery', 'canceled': 'GetWaypoints', 'low_battery': 'Charge', 'finished': 'Investigate'},
										autonomy={'failed': Autonomy.Inherit, 'canceled': Autonomy.Inherit, 'low_battery': Autonomy.Inherit, 'finished': Autonomy.Inherit},
										remapping={'waypoints': 'waypoints', 'min_battery': 'min_battery', 'ball_location': 'ball_location', 'ball_label': 'ball_label'})
